...
public enum MentoryCharacter: String, Sendable, Hashable, CaseIterable, Codable {
    ...
    public var question: String {
        switch self {
        case .cool:
            return "동기부여가 될만한 짧은 현실조언을 저번과 다르게 말해줘. 냉정한 태도로 말해줘. 마침표, 물음표, 느낌표를 제외한 특수문자들은 다 빼줘. 이모지는 어울리게 문장들 사이에 하나만 넣어줘"
        case .warm:
            return "마음을 보살펴주는 짧은 위로격려를 저번과 다르게 말해줘. 상냥한 말투로 말해줘. 마침표, 물음표, 느낌표를 제외한 특수문자들은 다 빼줘. 이모지는 어울리게 문장들 사이에 하나만 넣어줘"
        }
    }
}
